		...
		<view class="group">
			...
			<view class="item">
				<view class="content">
					...
					<input v-if="mode===1" class="input" type="text" v-model="breachContract" placeholder="请填写违约金金额"
			...
			<view class="item">
				<view class="content">
					...
					<input v-if="mode===1" class="input" type="text" v-model="delayingPayment" placeholder="请填写滞纳金金额"
						placeholder-style="font-size:28rpx;color:#b2b2b2;font-weight:100;" />
