<template>
	<view class="">
		...
		<view class="idCard">
			<image class="imgBox" :src="idCard3 || $util.fileUrl('/yinye.png')" mode="aspectFill" @click="getImg(3)"></image>
		</view>
		...
		<uni-popup ref="popup2" type="center" style="text-align: center;">
			...
			<image class="popImg" :src="$util.fileUrl('/yyzz.png')" mode="aspectFill"></image>
