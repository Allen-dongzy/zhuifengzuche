	...
	<view class="">
		<view class="box">
			...
			<view class="flexBox">
				...
				<view class="timeBox" @tap="goTime">取车时间</view>
				<view class="timeBox" style="margin-left: 10%;" @tap="goTime">换车时间</view>
			</view>

			<view class="flexBox">
				<view class="title">金额</view>
				<view class="idCard">
					<input class="inpBox" type="text" value="" placeholder="请填写金额" />
				</view>
			</view>
			...
			<view style="display: flex;margin-top: 30rpx;">
				...
				<view class="idCard">
					<textarea
						...
						type="text" value="" placeholder="请填写金额" />
				</view>
			</view>
		...
		<button style=" color: white;
			width: 90%;
				    ...
				    border-radius: 50px;
				    font-size: 32rpx;
				    height: 96rpx;line-height: 96rpx;letter-spacing: 10rpx;" type="default" @click="next()">完成</button>
...
<script>
	...
	export default {
		...
		methods: {
			goTime() {
				open('/pages/customerRecords/leaseTimeSelection')
			},
