<template>
	<view class="">
		<view class="topNav">
			<view style="width: 5%;text-align: center;"><image style="width: 20rpx;height: 20rpx;" src="../../static/1-1.png" mode=""></image></view>
			<view style="font-size: 32rpx;color: #5A7EFF;">基本信息</view>
			<view style="width: 10%;text-align: center;line-height: 3px;"><image style="width: 10rpx;height: 10rpx;" src="../../static/next1.png" mode=""></image></view>
			<view style="width: 5%;text-align: center;"><image style="width: 20rpx;height: 20rpx;" src="../../static/2.png" mode=""></image></view>
			<view style="font-size: 32rpx;">证件信息</view>
			<view style="width: 10%;text-align: center;line-height: 3px;"><image style="width: 10rpx;height: 10rpx;" src="../../static/next2.png" mode=""></image></view>
			<view style="width: 5%;text-align: center;"><image style="width: 20rpx;height: 20rpx;" src="../../static/3.png" mode=""></image></view>
					...
					<u-form-item :border-bottom="show">
						...
						<view class="moreInpbox">
							...
							<!-- <view style="width: 20%;background-color: #EFF0F3;color: #5A7EFF;font-size: 24rpx;"> -->
								...
								<image v-show="showpass==true" style="height: 40rpx;width: 40rpx;" src="../../static/kai.png" mode="" @click="look"></image>
							<!-- </view> -->
						</view>
					</u-form-item>
				</u-form>
...
<style>
	...
	.inpBox{
		background-color: #EFF0F3;border-radius: 10rpx;height: 74rpx;width: 90%;margin: auto;font-size: 24rpx;color: #999999;padding-left: 20rpx;
	}
	.fromTitel{
