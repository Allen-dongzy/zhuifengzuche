	...
	<view class="">
		<view class="topNav">
			<view style="width: 5%;text-align: center;">
				<image style="width: 20rpx;height: 20rpx;" src="../../static/1.png" mode=""></image>
			</view>
			<view style="font-size: 32rpx;">基本信息</view>
			<view style="width: 10%;text-align: center;line-height: 3px;">
				<image style="width: 10rpx;height: 10rpx;" src="../../static/next2.png" mode=""></image>
			</view>
			<view style="width: 5%;text-align: center;">
				<image style="width: 20rpx;height: 20rpx;" src="../../static/2.png" mode=""></image>
			</view>
			<view style="font-size: 32rpx;">证件信息</view>
			<view style="width: 10%;text-align: center;line-height: 3px;">
				<image style="width: 10rpx;height: 10rpx;" src="../../static/next1.png" mode=""></image>
			</view>
			<view style="width: 5%;text-align: center;">
				<image style="width: 20rpx;height: 20rpx;" src="../../static/3-3.png" mode=""></image>
			</view>
			...
			<u-form :model="form" ref="uForm" :border-bottom="show">
				...
				<u-form-item :border-bottom="show">
					...
					<view class="moreInpbox">
						...
						<image v-show="showpass==false" style="height: 40rpx;width: 40rpx;" src="../../static/guan.png"
							mode="" @click="look"></image>
						<image v-show="showpass==true" style="height: 40rpx;width: 40rpx;" src="../../static/kai.png"
							mode="" @click="look"></image>
						<!-- </view> -->
					</view>
				</u-form-item>
