<template>
	<view class="">
		<view class="titlebox" :style="{backgroundImage: 'url('+`${ossUrl}/mine/payinfo.png`+')'}">
			<view style="margin-left: 30rpx;padding-top: 60rpx;color:white;">{{info.examineStatus | statusFilter(type)}}
			</view>
		</view>
		...
		<view class="flexBox">
			...
			<view v-if="info.bankCardVO" class="flexright">
				{{info.bankCardVO.bankName}} {{info.bankCardVO.cardNumber}}
			</view>
		</view>
		...
		<view style="width: 90%;margin: auto;">
			<view v-for="(item, index) in images" :key="index"
				style="display: inline-block;margin: 40rpx 20rpx 40rpx 0;" @click="previewPics(images, index)">
