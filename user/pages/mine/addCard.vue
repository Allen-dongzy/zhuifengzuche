		...
		<view class="flexBox">
			...
			<view style="width: 40%;margin: auto;">
				<picker class="pickerBox" @change="bankChange" :value="index" :range="bankList" range-key="name">
					<view class="uni-input">{{ bankList[index] && bankList[index].name ? bankList[index].name : bank || '请选择所属银行' }}</view>
				</picker>
			</view>
		</view>
		<view class="flexBox">
			...
			<view style="width: 40%;margin: auto;text-align: right;">
				<input style="height: 100%;width: 100%;font-size: 24rpx;" v-model="branch" type="text" placeholder-style="text-align: right;" placeholder="填写开户支行信息" />
			</view>
		</view>
		<view class="flexBox">
			<view class="title">开户姓名</view>
			<view style="width: 40%;margin: auto;text-align: right;">
				<input style="height: 100%;width: 100%;font-size: 24rpx;" v-model="name" type="text" placeholder-style="text-align: right;" placeholder="填写开户人姓名" />
			</view>
		</view>
		<view class="flexBox">
			<view class="title">银行卡号</view>
			<view style="width: 40%;margin: auto;text-align: right;">
				<input style="height: 100%;width: 100%;font-size: 24rpx;" v-model="cardNum" type="text" placeholder-style="text-align: right;" placeholder="填写银行卡号" />
			</view>
		</view>
...
<script>
import { bankList } from '@/apis/bank'
import { bankCardAdd, bankCardEdit, bankCardDel } from '@/apis/bankCard'
