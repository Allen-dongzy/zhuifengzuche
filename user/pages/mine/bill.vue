<template>
	<view>
		...
		<view class="topBox" v-if="search==false">
			...
			<image style="width: 48rpx;height: 48rpx;" :src="`${ossUrl}/mine/time.png`" mode=""></image>
			...
			<view class="statusBox" style="margin-left: 22%;" @click="showSearch">
				<view class="">搜索</view>
				<image style="width:28rpx;height:28rpx;" :src="`${ossUrl}/mine/fangdajing.png`" mode=""></image>
			</view>
		</view>
