<template>
	<view>
		...
		<view class="topBox" v-if="search==false">
			...
			<image style="width: 48rpx;height: 48rpx;" :src="`${ossUrl}/mine/time.png`" mode="aspectFill"></image>
			...
			<view class="statusBox" style="margin-left: 22%;" @click="showSearch">
				<view class="">搜索</view>
				<image style="width:28rpx;height:28rpx;" :src="`${ossUrl}/mine/fangdajing.png`" mode="aspectFill"></image>
			</view>
		</view>
		...
		<view v-for="(item,index) in carList" :key="index" class="">
			<view v-if="item.type==0" class="contentBox">
...
<style>
	...
	.contentBox{
		width: 90%;border-bottom:20rpx solid #EFF0F3;padding: 20rpx 5%;
	}
