<template>
	<view>
		<view class="flexBox">
			...
			<view class="value"><input v-model="localRealName" :maxlength="10" type="text" placeholder-class="input" placeholder="填写姓名" /></view>
		</view>
		<view class="flexBox">
			<view class="title">身份证号</view>
			<view class="value"><input v-model="localIdCard" :maxlength="18" type="text" placeholder-class="input" placeholder="填写身份证号" /></view>
		</view>
		<view class="flexBox">
			<view class="title">紧急联系人</view>
			<view class="value"><input v-model="localEmergencyContactName" :maxlength="10" type="text" placeholder-class="input" placeholder="填写紧急联系人" /></view>
		</view>
		<view class="flexBox">
			<view class="title">紧急联系人方式</view>
			<view class="value"><input v-model="localEmergencyContactPhone" :maxlength="11" type="number" placeholder-class="input" placeholder="填写紧急联系人方式" /></view>
		</view>
...
export default {
	...
	methods: {
		...
		perfectInformation: throttle(async function() {
			...
			if (this.localEmergencyContactPhone && !isPhone(this.localEmergencyContactPhone)) return this.$toast('请输入正确的手机号')
			const params = {
