	...
	<view class="perfect-information">
		...
		<view class="list">
			<view class="item">
				...
				<input v-model="localRealName" :maxlength="10" type="text" placeholder="填写姓名"
			...
			<view class="item">
				...
				<input :maxlength="10" v-model="localEmergencyContactName" type="text" placeholder="填写紧急联系人"
					placeholder-class="place-input" />
			</view>
			<view class="item">
				<view class="name">紧急联系人联系方式</view>
				<input :maxlength="11" v-model="localEmergencyContactPhone" type="number" placeholder="填写紧急联系人联系方式"
					placeholder-class="place-input" />
			</view>
		</view>
