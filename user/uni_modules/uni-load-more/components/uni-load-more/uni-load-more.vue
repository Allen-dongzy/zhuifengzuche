...
<script>
	 ...
	 * @property {String} status = [more|loading|noMore|noData] loading 的状态
	 * 	@value more loading前
	 ...
	 * @property {Object} contentText 各状态文字说明，值为：{contentdown: "上拉显示更多",contentrefresh: "正在加载...",contentnomore: "没有更多数据了",contentnodata: "暂无数据"}
	...
	export default {
		...
		props: {
			status: {
				// 上拉的状态：more-loading前；loading-loading中；noMore-没有更多了；noData-暂无数据
				type: String,
				default: 'more'
			},
			showIcon: {
